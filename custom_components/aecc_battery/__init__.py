...
POWER_FLOW_ENTITY_IDS = (
    ...
    "sensor.aecc_battery_pv_charging_power",
    "sensor.aecc_battery_ac_charging_power",
    "sensor.aecc_battery_total_charge_power",
    "sensor.aecc_battery_battery_charging_power",
    "sensor.aecc_battery_battery_discharging_power",
